...
<div id="main">
    <div class="container-fluid mt-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <?php
            $currentPage = $_SERVER['REQUEST_URI']; // Ambil path lengkap URL
            ?>
            ...
            <div>
                <a href="tambah.php" class="btn btn-add me-2">
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle">
                                        <span class="badge badge-<?= $m['status'] == 'Tersedia' ? 'success' : 'danger' ?>">
                                            ...
                                            // Jika kosong, anggap "Tidak Tersedia"
                                            if (empty($status)) {
                                                $status = 'Tidak Tersedia';
                                            }

                                            // Tentukan warna badge
                                            $badge_class = 'secondary'; // default abu-abu
                                            if ($status == 'Tersedia') {
                                                $badge_class = 'success'; // hijau
                                            } elseif ($status == 'Dalam Masa Sewa') {
                                                $badge_class = 'warning'; // kuning
