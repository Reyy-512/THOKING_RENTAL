...
// Mengambil data booking dan merk mobil
$stmt = $koneksi->prepare("
    SELECT b.*, m.merk, DATE_ADD(b.tanggal, INTERVAL b.lama_sewa DAY) AS tanggal_jatuh_tempo 
    FROM booking b 
...
.dataTables_wrapper .dataTables_filter input {
    border-radius: 8px;
    border: 1px solid #16416bff;
    padding: 0.375rem 0.75rem;
}

.dataTables_wrapper .dataTables_length select {
    border-radius: 8px;
    border: 1px solid #dee6deff;
    padding: 0.375rem 0.75rem;
}
    ...
    <div class="container-fluid mt-4">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0"><i class="fas fa-calendar-check"></i> Daftar Penyewaan</h5>
            </div>
            <div class="card-body">
                            ...
                            <tbody>
                                <?php $no = 1; foreach ($data_jatuh_tempo as $row): ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><?= htmlspecialchars($row['merk']); ?></td> <!-- Tampilkan merk mobil -->
                                        ...
                                        <td class="text-center">
                                            <a href="peminjaman.php?id=<?= urlencode($row['kode_booking']); ?>" class="btn btn-simple border-primary btn-sm">
