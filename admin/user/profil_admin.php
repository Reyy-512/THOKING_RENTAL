...
if (!empty($_POST['nama_rental'])) {
    ...
    $row->execute($data);
    echo '<script>alert("Update Data Info Website Berhasil!");window.location="profil_admin.php";</script>';
    exit;
}
...
if (!empty($_POST['nama_pengguna'])) {
    ...
    echo '<script>alert("Update Profil Admin Berhasil!");window.location="profil_admin.php";</script>';
    exit;
}
