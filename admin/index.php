...
<div id="main">
    <div class="container-fluid mt-4">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="card stats-card">
                    <div class="stats-icon" style="background: #eaa424ff; color: white;">
            ...
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="card stats-card">
                    <div class="stats-icon" style="background: #194898ff; color: white;">
            ...
            <div class="col-lg-6 col-md-6 mb-4">
                <div class="card stats-card">
                    <div class="stats-icon" style="background: #01a84fff; color: white;">
