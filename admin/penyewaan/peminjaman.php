    ...
    <div class="container-fluid mt-4">
        <div class="card mb-4">
            <div class="card-header text-white ">
                <strong><h5 class="mb-0">Data Booking</h5></strong>
            </div>
            <div class="card-body">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" action="proses.php?id=konfirmasi">
                            ...
                            <!-- Card Info Mobil (Dikeluarkan dari tabel biar tidak terpotong) -->
                            <div class="card mt-3">
                            ...
                            <!-- Submit Button -->
                            <button type="submit" class="btn btn-primary float-right mt-3">Ubah Status</button>
                        </form>
                    </div>
                </div>
            </div>
